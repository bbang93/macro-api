...
class NetFunnelHelper:
    ...
    def _check(self, ip: Optional[str] = None):
        return self._make_request("chkEnter", ip)

    def _complete(self, ip: Optional[str] = None):
...
class SRT:
    ...
    def login(self, srt_id: Optional[str] = None, srt_pw: Optional[str] = None) -> bool:
        """Login to SRT server.
